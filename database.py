...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:
        ...
        ('CS101', date('now'), '17:45', '19:15', 'Classroom 1', 10),
        ('CS102', date('now'), '17:45', '19:15', 'Classroom 2', 10),
        ('BUS201', date('now'), '17:45', '19:15', 'Classroom 3', 10);
        ''')
        
        print("✅ HARDCODED Course Schedule: ")
        print("   CS101 → Classroom 1 (17:45 - 119:15) ")
        print("   CS102 → Classroom 2 (17:45 - 119:15) ")
        print("   BUS201 → Classroom 3 (17:45 - 119:15) ")
